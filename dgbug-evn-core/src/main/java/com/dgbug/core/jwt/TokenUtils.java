...
public class TokenUtils {
     ...
     */
    public static String create(String keyID, String issuer, String audience, String subject, Integer exprationTime, int notBeforeMinutesInThePast) throws JoseException {
        ...
        if (exprationTime != null)
            claims.setExpirationTimeMinutesInTheFuture(exprationTime.intValue());
    ...
    //验证方法
    public static JwtClaims valid(String token, String issuer, String audience, String subject) throws InvalidJwtException {
